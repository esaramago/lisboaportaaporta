!function(e, t) {
    ...
    const r = function(t) {
        ...
        encodeByteArray (r, e) {
            ...
            for(let l = 0; l < r.length; l += 3){
                var i = r[l], s = l + 1 < r.length, o = s ? r[l + 1] : 0, c = l + 2 < r.length, h = c ? r[l + 2] : 0;
                let e = (15 & o) << 2 | h >> 6, t = 63 & h;
        ...
        decodeStringToByteArray (e, t) {
            ...
            for(let c = 0; c < e.length;){
                var a = r[e.charAt(c++)], i = c < e.length ? r[e.charAt(c)] : 0;
                ++c;
                var s = c < e.length ? r[e.charAt(c)] : 64;
                ++c;
                var o = c < e.length ? r[e.charAt(c)] : 64;
                if (++c, null == a || null == i || null == s || null == o) throw Error();
        ...
        var t;
        return e, t = r(e), n.encodeByteArray(t, !0).replace(/\./g, "");
    };
    function c(e, t) {
    ...
    class o extends Error {
        constructor(e, t, r){
            super(t), this.code = e, this.customData = r, this.name = "FirebaseError", Object.setPrototypeOf(this, o.prototype), Error.captureStackTrace && Error.captureStackTrace(this, l.prototype.create);
        }
    }
    class l {
        constructor(e, t, r){
        ...
        create(e, ...t) {
            var n, r = t[0] || {}, a = `${this.service}/${e}`, i = this.errors[e], i = i ? (n = r, i.replace(d, (e, t)=>{
                var r = n[t];
                return null != r ? String(r) : `<${t}?>`;
            })) : "Error", i = `${this.serviceName}: ${i} (${a}).`;
            return new o(a, i, r);
        }
    }
    const d = /\{\$([^}]+)}/g;
    ...
    class m {
        ...
        subscribe(e, t, r) {
            ...
            n = function(e, t) {
                ...
                error: t,
                complete: r
            }, void 0 === n.next && (n.next = b), void 0 === n.error && (n.error = b), void 0 === n.complete && (n.complete = b);
    ...
    class E {
        ...
        getImmediate(e) {
            var t = this.normalizeInstanceIdentifier(null == e ? void 0 : e.identifier), r = null !== (r = null == e ? void 0 : e.optional) && void 0 !== r && r;
        ...
        initialize(e = {}) {
            var { options: t = {}  } = e, r = this.normalizeInstanceIdentifier(e.instanceIdentifier);
    ...
    const I = [];
    var w, C, D;
    (C = w = w || {})[C.DEBUG = 0] = "DEBUG", C[C.VERBOSE = 1] = "VERBOSE", C[C.INFO = 2] = "INFO", C[C.WARN = 3] = "WARN", C[C.ERROR = 4] = "ERROR", C[C.SILENT = 5] = "SILENT";
    const S = {
        debug: w.DEBUG,
        verbose: w.VERBOSE,
        info: w.INFO,
        ...
        if (!(t < e.logLevel)) {
            var n = (new Date).toISOString(), a = O[t];
    ...
    let T, P;
    const M = new WeakMap, R = new WeakMap, k = new WeakMap, F = new WeakMap, $ = new WeakMap;
    let j = {
        get (e, t, r) {
    ...
    function H(n) {
        return n !== IDBDatabase.prototype.transaction || "objectStoreNames" in IDBTransaction.prototype ? (P = P || [
            IDBCursor.prototype.advance,
            IDBCursor.prototype.continue,
            IDBCursor.prototype.continuePrimaryKey
        ]).includes(n) ? function(...e) {
            return n.apply(V(this), e), z(M.get(this));
        } : function(...e) {
            return z(n.apply(V(this), e));
        } : function(e, ...t) {
            var r = n.call(V(this), e, ...t);
            return k.set(r, e.sort ? e.sort() : [
                e
            ]), z(r);
        };
    }
    function x(e) {
        var i, t;
        return "function" == typeof e ? H(e) : (e instanceof IDBTransaction && (i = e, R.has(i) || (t = new Promise((e, t)=>{
            const r = ()=>{
    ...
    function J(e, t) {
        if (e instanceof IDBDatabase && !(t in e) && "string" == typeof t) {
            ...
            const a = t.replace(/FromIndex$/, ""), i = t !== a, s = W.includes(a);
            if (a in (i ? IDBIndex : IDBObjectStore).prototype && (s || U.includes(a))) {
                var r = async function(e, ...t) {
                    var r = this.transaction(e, s ? "readwrite" : "readonly");
                    let n = r.store;
                    return i && (n = n.index(t.shift())), (await Promise.all([
                        n[a](...t),
                        s && r.done
                    ]))[0];
                };
    ...
    const Y = "@firebase/app", X = new N("@firebase/app");
    var q;
    const Z = "[DEFAULT]", Q = {
    ...
    }, ee = new Map, te = new Map;
    function re(t, r) {
        try {
            t.container.addComponent(r);
        } catch (e) {
            X.debug(`Component ${r.name} failed to register with FirebaseApp ${t.name}`, e);
        }
    }
    function ne(e, t) {
    ...
    function ae(e) {
        var t = e.name;
        if (te.has(t)) return X.debug(`There were multiple attempts to register component ${t}.`), !1;
        te.set(t, e);
    ...
    class oe {
        constructor(e, t, r){
            this._isDeleted = !1, this._options = Object.assign({}, e), this._config = Object.assign({}, t), this._name = t.name, this._automaticDataCollectionEnabled = t.automaticDataCollectionEnabled, this._container = r, this.container.addComponent(new v("app", ()=>this, "PUBLIC"));
        }
        ...
        checkDestroyed() {
            if (this.isDeleted) throw se.create("app-deleted", {
                appName: this._name
            });
        }
    }
    ...
    function he(e, t = {}) {
        ...
        const a = n.name;
        if ("string" != typeof a || !a) throw se.create("bad-app-name", {
            appName: String(a)
        });
    ...
    async function le(e) {
        var t = e.name;
        ee.has(t) && (ee.delete(t), await Promise.all(e.container.getProviders().map((e)=>e.delete())), e.isDeleted = !0);
    }
    function de(e, t, r) {
        let n = null !== (i = Q[e]) && void 0 !== i ? i : e;
        r && (n += `-${r}`);
        var a = n.match(/\s|\//), i = t.match(/\s|\//);
        if (a || i) {
            const s = [
                `Unable to register library "${n}" with version "${t}":`
            ];
            return a && s.push(`library name "${n}" contains illegal characters (whitespace or "/")`), a && i && s.push("and"), i && s.push(`version name "${t}" contains illegal characters (whitespace or "/")`), void X.warn(s.join(" "));
        }
        ae(new v(`${n}-version`, ()=>({
                library: n,
                version: t
    ...
    function pe(e, t) {
        if (null !== e && "function" != typeof e) throw se.create("invalid-log-argument");
        !function(i, e) {
            for (const t of I){
                let a = null;
                e && e.level && (a = S[e.level]), t.userLogHandler = null === i ? null : (e, t, ...r)=>{
                    var n = r.map((e)=>{
    ...
    const fe = "firebase-heartbeat-database", ge = 1, me = "firebase-heartbeat-store";
    let be = null;
    function ve() {
        return be = be || (function(e, t, { blocked: r , upgrade: n , blocking: a , terminated: i  }) {
            const s = indexedDB.open(e, t), o = z(s);
            return n && s.addEventListener("upgradeneeded", (e)=>{
                n(z(s.result), e.oldVersion, e.newVersion, z(s.transaction));
            }), r && s.addEventListener("blocked", ()=>r()), o.then((e)=>{
    ...
    async function _e(e, t) {
        try {
            const n = await ve(), a = n.transaction(me, "readwrite"), i = a.objectStore(me);
            return await i.put(t, Ee(e)), a.done;
        } catch (e) {
            var r;
            e instanceof o ? X.warn(e.message) : (r = se.create("idb-set", {
    ...
    class ye {
        constructor(e){
            ...
            this._storage = new we(t), this._heartbeatsCachePromise = this._storage.read().then((e)=>this._heartbeatsCache = e);
        }
        ...
        async getHeartbeatsHeader() {
            ...
            var e = Ie(), { heartbeatsToSend: t , unsentEntries: r  } = function(e, t = 1024) {
                const r = [];
                let n = e.slice();
                for (const a of e){
            ...
            }(this._heartbeatsCache.heartbeats), t = a(JSON.stringify({
                version: 2,
                heartbeats: t
            }));
        ...
        async read() {
            return await this._canUseIndexedDBPromise && await async function(e) {
                try {
                    ...
                    var t;
                    e instanceof o ? X.warn(e.message) : (t = se.create("idb-get", {
                        originalErrorMessage: null == e ? void 0 : e.message
                    }), X.warn(t.message));
                }
            }(this.app) || {
    ...
    q = "", ae(new v("platform-logger", (e)=>new K(e), "PRIVATE")), ae(new v("heartbeat", (e)=>new ye(e), "PRIVATE")), de(Y, "0.9.1", q), de(Y, "0.9.1", "esm2017"), de("fire-js", "");
    ...
    class Se {
        constructor(e, t){
            this._delegate = e, this.firebase = t, re(e, new v("app-compat", ()=>this, "PUBLIC")), this.container = e.container;
        }
        get automaticDataCollectionEnabled() {
        ...
        delete() {
            ...
            }).then(()=>(this.firebase.INTERNAL.removeApp(this.name), le(this._delegate)));
        }
        _getService(e, t = Z) {
            var r;
    ...
    function Oe(a) {
        const i = {}, s = {
            ...
            INTERNAL: {
                registerComponent: function(r) {
                    const n = r.name, t = n.replace("-compat", "");
                    var e;
                    ae(r) && "PUBLIC" === r.type && (e = (e = o())=>{
        ...
        function o(e) {
            if (e = e || Z, !p(i, e)) throw Ae.create("no-app", {
                appName: e
            });
            return i[e];
        }
  ...
  `);
        ...
        Te && 0 <= Te.indexOf("LITE") && Ne.warn(`
    Warning: You are trying to load Firebase while using Firebase Performance standalone script.
    You should load Firebase Performance with this instance of Firebase to avoid loading duplicate code.
    `);
    }
    const Be = Le;
    de("@firebase/app-compat", "0.2.1", void 0);
    return Be.registerVersion("firebase", "9.16.0", "app-compat-cdn"), Be;
});

//# sourceMappingURL=index.89552994.js.map
